...
module HarzardUnit(
    ...
    input wire BranchE, BTB_HitE, BHT_HitE, JalrE, JalD, BrInstE,
    ...
    begin
        ...
        begin
            ...
            if (Branch_Flush | JalrE)                        //handle Jal && Jalr && Branch
            begin
                FlushD = 1'b1;
            end
            else if (JalD == 1'b1)
            ...
            if (((Rs1D == RdE || Rs2D == RdE) && MemToRegE == 1'b1) || (Branch_Flush == 1'b1 || JalrE == 1'b1))  //when load or branch, FlushE
                FlushE = 1'b1;
            else
                FlushE = 1'b0;
